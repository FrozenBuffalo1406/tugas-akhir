...
static const char* SERVER_ADDRESS = "http://192.168.1.30:8080";

// --- Konfigurasi Layar OLED ---
static const int SCREEN_WIDTH = 128; // Lebar layar OLED, biasanya 128
static const int SCREEN_HEIGHT = 64;  // Tinggi layar OLED, biasanya 64 atau 32
static const int OLED_RESET_PIN = -1; // Pin reset (-1 jika tidak dipakai)
static const int OLED_I2C_ADDR = 0x3C; // Alamat I2C, biasanya 0x3C atau 0x3D
...
static const int FACTORY_RESET_PIN = 0;
...
static const long INACTIVITY_TIMEOUT_MS = 60000;
static const long longPressDuration = 3000;
