...
def analyze_ecg():
    ...
    try:
        ...
        prediction_probabilities = {"Normal": 1.0, "Atrial Fibrillation": 0.0, "Pre Ventricular Contraction": 0.0}
...
if __name__ == '__main__':
    ...
    print(f"Menjalankan server Waitress di http://192.168.1.29:8080")
